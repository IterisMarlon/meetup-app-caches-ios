...
class SwiftOverlays: NSObject {
    ...
    */
    @discardableResult
    class func showBlockingWaitOverlay() -> UIView {
    ...
    */
    @discardableResult
    class func showBlockingWaitOverlayWithText(_ text: String) -> UIView {
        let blocker = addMainWindowBlocker()
    ...
    /**
        ...
        - returns: Created overlay
    */
    class func showBlockingImageAndTextOverlay(_ image: UIImage, text: String) -> UIView  {
        let blocker = addMainWindowBlocker()
    ...
    */
    @discardableResult
    class func showBlockingTextOverlay(_ text: String) -> UIView  {
        let blocker = addMainWindowBlocker()
    ...
    */
    class func removeAllBlockingOverlays() {
    ...
    // MARK: Non-blocking
    @discardableResult
    class func showCenteredWaitOverlay(_ parentView: UIView) -> UIView {
    ...
    @discardableResult
    class func showCenteredWaitOverlayWithText(_ parentView: UIView, text: String) -> UIView  {
    ...
    @discardableResult
    class func showImageAndTextOverlay(_ parentView: UIView, image: UIImage, text: String) -> UIView  {
        let imageView = UIImageView(image: image)
        
        return showGenericOverlay(parentView, text: text, accessoryView: imageView)
    }

    class func showGenericOverlay(_ parentView: UIView, text: String, accessoryView: UIView, horizontalLayout: Bool = true) -> UIView {
    ...
    @discardableResult
    class func showTextOverlay(_ parentView: UIView, text: String) -> UIView  {
        let label = labelForText(text)
    ...
    class func showProgressOverlay(_ parentView: UIView, text: String) -> UIView  {
        let pv = UIProgressView(progressViewStyle: .default)
        
        return showGenericOverlay(parentView, text: text, accessoryView: pv, horizontalLayout: false)
    }
    
    class func removeAllOverlaysFromView(_ parentView: UIView) {
        parentView.subviews
            .filter { $0.tag == containerViewTag }
            .forEach { $0.removeFromSuperview() }
    }
    
    class func updateOverlayText(_ parentView: UIView, text: String) {
        if let overlay = parentView.viewWithTag(containerViewTag) {
            overlay.subviews.compactMap { $0 as? UILabel }.first?.text = text
        }
    }
    
    class func updateOverlayProgress(_ parentView: UIView, progress: Float) {
        if let overlay = parentView.viewWithTag(containerViewTag) {
    ...
    @objc class func closeNotificationOnTopOfStatusBar(_ sender: AnyObject) {
